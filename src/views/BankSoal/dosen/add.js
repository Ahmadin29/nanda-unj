...
export default function AddBankSoalDosen(params) {
  ...
  const saveDosen = ()=>{
    ...
    setedBankSoal.push({
        id:setedBankSoal[setedBankSoal.length - 1].id + 1,
        matakuliah:selectedMatkul.namaMatKul,
        kodeMatKul:selectedMatkul.kodematkul,
        jumlah:jumlah,
        status:status,
        soal:[]
    })
    ...
    Swal.fire({
      title: 'Berhasil!',
      text: 'Berhasil menambahkan data bank soal',
      icon: 'success',
