...
import SoalTemplate from '../../../../assets/soal-template.csv';
...
export default function ImportSoalDosen() {
          ...
          <CardBody>
            <div style={{
              ...
              <div>
                ...
                <Button onClick={()=>openReader()} color="success">Import Data Soal</Button>
        ...
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            <CardHeader color="success">
              <h4 className={classes.cardTitleWhite}>Data Soal</h4>
            ...
            <CardFooter>
              <Button onClick={()=>upload()} color="success">Tambahkan Data Soal</Button>
            </CardFooter>
          </Card>
        </GridItem>
      }
