...
import MahasiswaTemplate from '../../../assets/mahasiswa-template.csv';
...
export default function ImportMahasiswaAdmin() {
  ...
  const downloadFile = ()=>{
    location.href=MahasiswaTemplate
  };
  ...
  const processData = dataString => {
    ...
    const data = list.map(v=>([v.nim,v.namaLengkap,v.email,v.nomorTelepon,v.password,v.angkatan]));
          ...
          <CardBody>
            <div style={{
              ...
              <div>
                ...
                <Button onClick={()=>openReader()} color="success">Import Data Mahasiswa</Button>
      ...
      fileAvailable &&
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            ...
            <CardFooter>
              <Button onClick={()=>upload()} color="success">Tambahkan Data Mahasiswa</Button>
            </CardFooter>
          </Card>
        </GridItem>
      }
