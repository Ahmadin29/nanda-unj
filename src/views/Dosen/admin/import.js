...
import DosenTemplate from '../../../assets/dosen-template.csv';
...
export default function ImportDosenAdmin() {
  ...
  const processData = dataString => {
    ...
    const data = list.map(v=>([v.nip,v.nidn,v.nidk,v.namaLengkap,v.email,v.nomorTelepon,v.password]));
          ...
          <CardBody>
            <div style={{
              ...
              <div>
                ...
                <Button onClick={()=>openReader()} color="success">Import Data Dosen</Button>
      ...
      fileAvailable &&
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            ...
            <CardFooter>
              <Button onClick={()=>upload()} color="success">Tambahkan Data Dosen</Button>
            </CardFooter>
          </Card>
        </GridItem>
      }
