...
import MatkulTemplate from '../../../assets/matkul-template.csv';
...
export default function ImportMatkulAdmin() {
  ...
  const processData = dataString => {
    ...
    const data = list.map(v=>([v.kodematkul,v.namaMatKul,v.deskripsi]));
  ...
  const upload = ()=>{
    ...
    Swal.fire({
      title: 'Berhasil!',
      text: 'Berhasil menambahkan data Mata Kuliah',
      icon: 'success',
          ...
          <CardBody>
            <div style={{
              ...
              <span style={{
                fontSize:20,
                fontWeight:700,
              }} >Daftar Data Mata Kuliah</span>
              <div>
                <Button onClick={()=>downloadFile()} color="primary">Download Template</Button>
                <Button onClick={()=>openReader()} color="success">Import Data Mata Kuliah</Button>
      ...
      fileAvailable &&
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            ...
            <CardFooter>
              <Button onClick={()=>upload()} color="success">Tambahkan Data Mata Kuliah</Button>
            </CardFooter>
          </Card>
        </GridItem>
      }
