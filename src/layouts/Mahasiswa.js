...
import MahasiswaProfile from "views/UserProfile/mahasiswa.js";
import UjianScheduledMahasiswa from "views/Ujian/mahasiswa/result/scheduled";
...
export default function Mahasiswa({ ...rest }) {
  // styles
